...
이 프로젝트는 SSAFY 2학기 공통 프로젝트의 Demo MVP 성격으로 구현되었습니다. 미리받기, 송금, 보관 기능은 테스트넷과 데모 잔고 기반 PoC이며, 실거래, 실정산, 수익 보장을 목적으로 하지 않습니다.
...
| GPS 출근 | 급여 확인 | 미리받기 | 송금 |
| --- | --- | --- | --- |
| <img src="exec/Image/GpsCheckIn.png" width="180" alt="GPS 출근 화면" /> | <img src="exec/Image/WageCheck_04.png" width="180" alt="급여 확인 화면" /> | <img src="exec/Image/AdvanceEligibility.png" width="180" alt="미리받기 가능 금액 화면" /> | <img src="exec/Image/Transfer_05.png" width="180" alt="송금 완료 화면" /> |

| 보관 | 다국어 | 고용주 승인 | 웹 전환 |
| --- | --- | --- | --- |
| <img src="exec/Image/VaultDetail.png" width="180" alt="보관 상세 화면" /> | <img src="exec/Image/LanguageMode_04.png" width="180" alt="다국어 모드 화면" /> | <img src="exec/Image/EmployerApproval.png" width="180" alt="고용주 승인 화면" /> | <img src="exec/Image/WebSwitch.png" width="180" alt="웹 전환 화면" /> |
...
- DonDone MVP의 미리받기, 송금, 보관은 demo/testnet 범위입니다.
- 실제 금융 서비스, 실제 정산, 투자 수익 보장으로 오해될 수 있는 표현을 피해야 합니다.
