...
private val appTextCatalog: Map<AppTextKey, AppTextEntry> = mapOf(
    ...
    "minutes_format" to appTextEntry(korean = "%d\ubd84", english = "%dm"),
    ...
    "finance_approx_amount_format" to appTextEntry(korean = "\uc57d %s", english = "around %s"),
    "finance_cannot_request_right_now" to appTextEntry(korean = "\uc9c0\uae08\uc740 \ubbf8\ub9ac\ubc1b\uae30\ub97c \uc2e0\uccad\ud560 \uc218 \uc5c6\uc5b4\uc694", english = "You can't request an advance right now."),
    "finance_can_request_right_now" to appTextEntry(korean = "\ubbf8\ub9ac\ubc1b\uae30\ub97c \uc2e0\uccad\ud560 \uc218 \uc788\uc5b4\uc694", english = "You can request an advance now."),
    "finance_check_available_amount_and_request" to appTextEntry(korean = "\ud604\uc7ac \uac00\ub2a5 \uae08\uc561\uc744 \ud655\uc778\ud558\uace0 \uc2e0\uccad\ud560 \uc218 \uc788\uc5b4\uc694.", english = "Check the available amount and submit your request."),
    "finance_unreflected_records_notice_title" to appTextEntry(korean = "\uc544\uc9c1 \ubc18\uc601\ub418\uc9c0 \uc54a\uc740 \uae30\ub85d\uc774 \uc788\uc5b4\uc694", english = "Some records haven't been reflected yet."),
    "finance_unreflected_records_notice_body" to appTextEntry(korean = "\ud655\uc778 \uc911\uc778 \uae30\ub85d\uc740 \uc9c0\uae08 \uac00\ub2a5 \uae08\uc561\uc5d0 \ubc18\uc601\ub418\uc9c0 \uc54a\uc558\uc5b4\uc694.", english = "Records under review aren't included in the available amount yet."),
    "finance_unreflected_records_notice_body_with_count" to appTextEntry(korean = "%d\uac74\uc740 \uc544\uc9c1 \ud655\uc778\uc911\uc774\ub77c \uc9c0\uae08 \uac00\ub2a5 \uae08\uc561\uc5d0 \ubc18\uc601\ub418\uc9c0 \uc54a\uc558\uc5b4\uc694.", english = "%d records are still under review, so they aren't included in the available amount yet."),
    ...
    "workproof_demo_fallback_message" to appTextEntry(
        korean = "\ud604\uc7ac \ubcf4\uc774\ub294 \uadfc\ubb34 \uae30\ub85d\uc740 \ub370\ubaa8 \ub370\uc774\ud130\uc785\ub2c8\ub2e4. \ud68c\uc0ac \ub4f1\ub85d \ud6c4 \uc2e4\uc81c \uae30\ub85d\uc73c\ub85c \uc804\ud658\ub429\ub2c8\ub2e4.",
        english = "The work records currently shown are demo data. They switch to real records after company registration."
    ),
    ...
    "workproof_select_period_first" to appTextEntry(korean = "\ubb38\uc11c\ub85c \uc815\ub9ac\ud560 \uae30\uac04\uc744 \uba3c\uc800 \uc120\ud0dd\ud574 \uc8fc\uc138\uc694.", english = "Select the date range for the document first."),
    "workproof_selected_period_summary_notice" to appTextEntry(korean = "\uc120\ud0dd\ud55c \uae30\uac04 \uae30\uc900 \uc2e4\uc81c \uadfc\ubb34 \uae30\ub85d \uc694\uc57d\uc744 \ud655\uc778\ud55c \ub4a4 \ubb38\uc11c\ub97c \uc0dd\uc131\ud560 \uc218 \uc788\uc5b4\uc694.", english = "Review the work summary for the selected period before generating the document."),
    "workproof_document_preview" to appTextEntry(korean = "\ubb38\uc11c \ubbf8\ub9ac\ubcf4\uae30", english = "Document Preview"),
    "workproof_item_count" to appTextEntry(korean = "%d\uac74", english = "%d items"),
    "item_count_format" to appTextEntry(korean = "%d\uac74", english = "%d items"),
    "workproof_section_summary_value" to appTextEntry(korean = "\ucd9c\ud1f4\uadfc \uae30\ub85d, \uc218\uc815 \uc774\ub825, \uae30\uac04 \uc694\uc57d", english = "Clock-in/out records, edit history, and period summary"),
    "workproof_hours_minutes_format" to appTextEntry(korean = "%d\uc2dc\uac04 %d\ubd84", english = "%dh %dm"),
    "workproof_hours_only_format" to appTextEntry(korean = "%d\uc2dc\uac04", english = "%dh"),
    "workproof_minutes_only_format" to appTextEntry(korean = "%d\ubd84", english = "%dm"),
    ...
    "workproof_rejected" to appTextEntry(korean = "\ubc18\ub824\ub428", english = "Rejected"),
    "workproof_excluded" to appTextEntry(korean = "\uc81c\uc678\ub428", english = "Excluded"),
    "workproof_partial_recorded" to appTextEntry(korean = "\ucd9c\uadfc\ub9cc", english = "Clock-in Only"),
    ...
    "workproof_recognized_time_value" to appTextEntry(korean = "\uc778\uc815 \uc2dc\uac04: %1\$s", english = "Recognized Time: %1\$s"),
    "workproof_edit_reason_prefix" to appTextEntry(korean = "\uc218\uc815 \uc0ac\uc720", english = "Edit Reason"),
    "workproof_rejection_reason_value" to appTextEntry(korean = "\ubc18\ub824 \uc0ac\uc720: %1\$s", english = "Rejection Reason: %1\$s"),
    ...
    "workproof_rejected_by_workplace" to appTextEntry(korean = "\uc0ac\uc5c5\uc7a5\uc5d0\uc11c \ubc18\ub824\ub428", english = "Rejected by Workplace"),
    ...
    "transfer_sending_request" to appTextEntry(korean = "\uc1a1\uae08\uc694\uccad\uc744 \uc811\uc218 \ud588\uc5b4\uc694.", english = "Your transfer request has been received."),
    "transfer_completed_detail" to appTextEntry(korean = "\uc1a1\uae08\uc744 \uc644\ub8cc \ud588\uc5b4\uc694.", english = "Your transfer is complete."),
    "transfer_request_received_toast" to appTextEntry(korean = "\uc1a1\uae08 \uc694\uccad\uc744 \uc811\uc218\ud588\uc5b4\uc694.", english = "Your transfer request has been received."),
    "transfer_completed_toast" to appTextEntry(korean = "\uc1a1\uae08\uc774 \uc644\ub8cc\ub410\uc5b4\uc694.", english = "Your transfer is complete."),
    "transfer_request_failed_toast" to appTextEntry(korean = "\uc1a1\uae08 \uc694\uccad\uc744 \ubcf4\ub0b4\uc9c0 \ubabb\ud588\uc5b4\uc694.", english = "Couldn't send the transfer request."),
    ...
    "transfer_request_created" to appTextEntry(korean = "\uc1a1\uae08\uc694\uccad\uc744 \uc811\uc218 \ud588\uc5b4\uc694.", english = "Your transfer request has been received."),
    ...
    "transfer_confirmed_status_detail" to appTextEntry(korean = "\uc1a1\uae08\uc744 \uc644\ub8cc \ud588\uc5b4\uc694.", english = "Your transfer is complete."),
    ...
    "recipient_add_wallet_title" to appTextEntry(korean = "\uc218\uc2e0 \uc9c0\uac11 \ucd94\uac00", english = "Add Recipient Wallet"),
    "recipient_add_wallet_description" to appTextEntry(korean = "\ud734\ub300\ud3f0 \ubc88\ud638\ub85c \uba3c\uc800 \ucc3e\uace0, \uc5c6\uc73c\uba74 \uc9c0\uac11 \uc8fc\uc18c\ub97c \uc9c1\uc811 \uc785\ub825\ud560 \uc218 \uc788\uc5b4\uc694.", english = "Search by phone number first, or enter the wallet address directly if needed."),
    "recipient_register_wallet" to appTextEntry(korean = "\uc9c0\uac11 \ub4f1\ub85d\ud558\uae30", english = "Register Wallet"),
    "recipient_find_by_phone" to appTextEntry(korean = "\ud734\ub300\ud3f0 \ubc88\ud638\ub85c \ucc3e\uae30", english = "Find by Phone"),
    "recipient_enter_wallet_directly" to appTextEntry(korean = "\uc9c0\uac11 \uc8fc\uc18c \uc9c1\uc811 \uc785\ub825", english = "Enter Wallet Directly"),
    "recipient_phone_number" to appTextEntry(korean = "\ud734\ub300\ud3f0 \ubc88\ud638", english = "Phone Number"),
    "recipient_find_registered_wallet_by_phone" to appTextEntry(korean = "\ub4f1\ub85d\ub41c DonDone \ud68c\uc6d0 \uc9c0\uac11\uc744 \uc804\ud654\ubc88\ud638\ub85c \ucc3e\uc544\uc694.", english = "Find registered DonDone member wallets by phone number."),
    "recipient_find_in_demo_contacts_only" to appTextEntry(korean = "\ud604\uc7ac\ub294 DonDone \ub370\ubaa8 \uc5f0\ub77d\ucc98\uc5d0\uc11c\ub9cc \ucc3e\uc544\uc694.", english = "Currently, search is available only in the DonDone demo contacts."),
    "recipient_search_by_phone_number" to appTextEntry(korean = "\ubc88\ud638\ub85c \uac80\uc0c9", english = "Search by Number"),
    "recipient_can_register_direct_if_knows_wallet" to appTextEntry(korean = "\uc9c0\uac11 \uc8fc\uc18c\ub97c \uc54c\uace0 \uc788\ub2e4\uba74 \uc9c1\uc811 \uc785\ub825\uc73c\ub85c \ubc14\ub85c \ub4f1\ub85d\ud560 \uc218 \uc788\uc5b4\uc694.", english = "If you know the wallet address, you can register it directly."),
    "recipient_switch_to_direct_wallet_input" to appTextEntry(korean = "\uc9c0\uac11 \uc8fc\uc18c \uc9c1\uc811 \uc785\ub825\uc73c\ub85c \uc804\ud658", english = "Switch to Direct Wallet Entry"),
    "recipient_no_matching_contact" to appTextEntry(korean = "\uc77c\uce58\ud558\ub294 \uc5f0\ub77d\ucc98\uac00 \uc5c6\uc5b4\uc694.", english = "No matching contact was found."),
    "recipient_already_registered_wallet" to appTextEntry(korean = "\uc774\ubbf8 \ub4f1\ub85d\ub41c \uc9c0\uac11", english = "Already Registered Wallet"),
    "recipient_alias" to appTextEntry(korean = "\ubcc4\uce6d", english = "Alias"),
    "recipient_wallet_address" to appTextEntry(korean = "\uc9c0\uac11 \uc8fc\uc18c", english = "Wallet Address"),
    "recipient_enter_testnet_evm_wallet" to appTextEntry(korean = "\ud14c\uc2a4\ud2b8\ub137 EVM \uc9c0\uac11 \uc8fc\uc18c\ub97c \uc785\ub825\ud574 \uc8fc\uc138\uc694.", english = "Enter a testnet EVM wallet address."),
    "recipient_enter_42_char_0x" to appTextEntry(korean = "0x\ub85c \uc2dc\uc791\ud558\ub294 42\uc790\ub9ac \uc8fc\uc18c\ub97c \uc785\ub825\ud574 \uc8fc\uc138\uc694.", english = "Enter a 42-character address starting with 0x."),
    "recipient_relationship" to appTextEntry(korean = "\uad00\uacc4", english = "Relationship"),
    "recipient_selected_contact" to appTextEntry(korean = "\uc120\ud0dd\ud55c \uc5f0\ub77d\ucc98", english = "Selected Contact"),
