...
public record EmployerInvitationAcceptRequest(
        @Schema(description = "Employer invitation token", example = "invite-token-123")
        @NotBlank(message = "Token is required")
        String token,

        @Schema(description = "Invitee email", example = "manager@acme.test")
